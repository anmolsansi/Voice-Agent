...
export function IntakeStartCard({ reviewHref }: IntakeStartCardProps) {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 p-5">
      <h2 className="text-lg font-semibold text-slate-900">Start or resume check-in</h2>
      <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
        Begin a new intake session here. If this device already has an in-progress session, patients can pick up where they left off without re-entering their information.
      </p>
